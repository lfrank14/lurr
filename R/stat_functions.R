...
# Summary statistics --> on dataframe or a vector?
# Basic stats tests that spit out stats in cleaner way
# Mean function that can average across rows or columns depending on what I specify
# SE function that can average across rows or columns depending on what I specify 